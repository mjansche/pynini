...
template <class A>
bool CompileByteString(const string &str, const typename A::Weight &weight,
                       MutableFst<A> *fst) {
  using Arc = A;
  using Label = typename Arc::Label;
...
template <class A>
bool CompileUTF8String(const string &str, const typename A::Weight &weight,
                       MutableFst<A> *fst) {
  using Arc = A;
  using Label = typename Arc::Label;
  std::vector<Label> labels;
